// WHY: Update budolID Vercel production env vars to point at the WORKING Neon endpoint
// The old ep-bitter-wildflower endpoint has stale/rotated credentials
...
const varsToSet = {
    ...
    'BUDOLPAY_DATABASE_URL': process.env.DATABASE_URL + '&schema=budolpay',
