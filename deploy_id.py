...
try:
    ...
    subprocess.check_call("docker build -t budol-id:v28 ./budolid-0.1.0", shell=True)

    print("Pushing to ECR...")
    subprocess.check_call("docker tag budol-id:v28 194442925745.dkr.ecr.ap-southeast-1.amazonaws.com/budol-id:v28", shell=True)
    subprocess.check_call("docker push 194442925745.dkr.ecr.ap-southeast-1.amazonaws.com/budol-id:v28", shell=True)
