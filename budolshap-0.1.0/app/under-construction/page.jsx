    ...
    return (
        <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <motion.div
                ...
                className="max-w-4xl w-full bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-12 text-center relative z-10 border border-white/50"
            >
                <motion.div
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-10">
                    ...
                    <motion.div
                        ...
                        className="p-4 rounded-xl bg-slate-50 border border-slate-100 hover:border-blue-200 hover:shadow-md transition-all group"
                    >
                        <a
