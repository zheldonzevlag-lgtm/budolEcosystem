    ...
    return (
        <div className="p-6 bg-slate-50 rounded-xl border-2 border-slate-100 mb-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-center gap-4 text-2xl font-black text-slate-900 bg-white p-4 rounded-lg border border-slate-200 shadow-inner">
                    <span>{num1}</span>
                    ...
                    <input
                        ...
                        className={`w-20 text-center border-2 rounded-lg focus:outline-none transition-all ${
                            error ? 'border-red-500 bg-red-50 animate-shake' : 'border-slate-200 focus:border-rose-500'
                        }`}
                        placeholder="?"
                        autoFocus
                        required
