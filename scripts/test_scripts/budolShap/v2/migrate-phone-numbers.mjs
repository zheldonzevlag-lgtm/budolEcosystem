/**
 * Budol Ecosystem: Phone Number Migration Script
 * Normalizes all legacy phone numbers in the database to E.164 format.
 * Target Tables: User (phoneNumber), Store (contact), Address (phone), StoreAddress (phone)
 * 
 * Compliance: NPC (Data Privacy), BSP (Financial Standards)
 */

import { PrismaClient } from '../../../budolshap-0.1.0/node_modules/@prisma/client/index.js';
import { normalizePhone } from '../../../budolshap-0.1.0/lib/utils/phone-utils.js';
